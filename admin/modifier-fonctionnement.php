<?php if (isset($_POST['modifier'])) {
	file_put_contents('../admin/fichiers-txt/fonctionnement.txt', $_POST['texte']);
} 
$ligne = file_get_contents('../admin/fichiers-txt/fonctionnement.txt', FILE_USE_INCLUDE_PATH);
?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
	<title>Modification de la page "Fonctionnement" - Mam'Ourson</title>
...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-lg-10">
				<center>
					<h1 style="padding-top: 20px;">Modification de la page "Fonctionnement"</h1>
				</center>
				<hr>
