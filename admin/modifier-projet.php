<?php if (isset($_POST['modifier'])) {
	file_put_contents('../admin/fichiers-txt/projet.txt', $_POST['texte']);
} 
...
<head>
	<meta charset="utf-8">
	<title>Modification de la page "Projet" - Mam'Ourson</title>
...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-lg-10">
				<center>
					<h1 style="padding-top: 20px;">Modification de la page "Projet"</h1>
				</center>
				<hr>
